...
- amount 9 in a group that has other amounts 9 exclude the totals of the other amounts in the range - [#332](https://github.com/PHPOffice/PhpSpreadsheet/issues/332)
