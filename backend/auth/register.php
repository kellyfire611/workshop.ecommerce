...
if (!isset($_POST['btnRegister'])) {
    ...
    echo $twig->render('backend/auth/register.html.twig');
    return;
}
    ...
    <table>
        ...
        <tr>
            <td>
                ...
                <a href="$siteUrl/backend/auth/activate-user.php?email=$email&activate_code=$activate_code">Kích hoạt tài khoản</a>
            </td>
        </tr>
        <tr>
            <td>
